...
<?php
  ...
  // show thong tin lớp
  $sql  = "SELECT * FROM lop,nganh where lop.manganh  = nganh.manganh ";
  $r = $exp->fetch_all($sql);
        ...
        <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" > -->
          <div class="col-md-8 col-md-offset-3 " >
            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <br />
                <form method="post" action="../lop/add.php" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Mã lớp
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input name="malop" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="last-name" name="tenlop" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="last-name" name="namnhaphoc" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th class="info">Mã lớp</th>
                      <th class="info">Tên lớp</th>
                      <th class="info">Năm nhập học</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $value["namnhaphoc"]; ?></td>
                      <td><?php echo $value["tennganh"]; ?></td>
                      <td><a href="../lop/delete.php?id=<?php echo $value['malop']; ?>" onclick="return confirm('Chắc chắn xóa?')"><button type="button" name="button" class="btn btn-danger"><i class="fa fa-trash"></i></button></a></td>
                      <td><a href="../lop/edit.php?id=<?php echo $value['malop']; ?>"><button type="button" name="button" class="btn btn-primary"><i class="fa fa-wrench"></i></button></a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
