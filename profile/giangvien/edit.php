...
<?php
  // lấy thông tin giangvien cần sửa
                ...
                <form method="post"  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input name="magv" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $r["magv"]; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="last-name" name="tengv" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $r["tengv"]; ?>">
                    </div>
                  </div>
